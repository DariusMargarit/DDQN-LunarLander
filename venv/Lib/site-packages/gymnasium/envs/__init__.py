...
register(
    id="RewardCustomLunarLander",
    entry_point="gymnasium.envs.box2d.reward_custom_lunar_lander:LunarLanderCustom",
    max_episode_steps=1000,
)

register(
    id="EvalCustomLunarLander",
    entry_point="gymnasium.envs.box2d.eval_custom_lunar_lander:LunarLanderCustom",
    max_episode_steps=1000,
)
